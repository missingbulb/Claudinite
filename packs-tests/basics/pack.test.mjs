...
import { makeRepo, deletePath, cleanup, git, writeFiles, makeTranscript } from '../../engine-tests/checks/helpers.mjs';
...
const CORPUS_MARKERS = {
  'engine/packs/registry.mjs': '// corpus marker\n',
  'engine/skills/registry.mjs': '// corpus marker\n',
};
