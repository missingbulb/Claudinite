...
const rule = declaredCheck('packs/grow_with_claudinite/skills/unattended-agents', 'in-session-github-access');
...
test('in-session-github-access: a scheduled task\'s preprocessing worker keeps its REST client', () => {
  // code_work runs Action-side as a subprocess with an injected
