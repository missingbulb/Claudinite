...
|---|---|---|
| `growth-extract-new-instructions` ([extract.md](../../packs/grow_with_claudinite/extract.md)) | the project changed in the window | the project's own local packs, via a PR that auto-merges after CI |
| `growth-dedup-local-instructions` ([dedup.md](../../packs/grow_with_claudinite/dedup.md)) | canon changed, or the project's local packs changed (or weekly) | a PR against the project's `main` |
| `growth-discover-packs` ([discover-packs.md](../../packs/grow_with_claudinite/discover-packs.md)) | the member's weekly full sweep | one PR per authored pack, against Claudinite's canon |
...
2. **Fresh pass — the [conversation-extract](../../packs/grow_with_claudinite/conversation-extract.md) run_daily task** (gate: the
   ...
   [extracting-lessons.md](../../packs/grow_with_claudinite/extracting-lessons.md) (the method — friction signals and the
   ...
   ([render-dialogue.mjs](../../packs/grow_with_claudinite/render-dialogue.mjs)) on the worked issue for each rule that landed —
...
| Rule | Kind | What |
|---|---|---|
| `growth-config` | hardcoded ([config-check.mjs](../../packs/grow_with_claudinite/config-check.mjs)) | entry config shape valid |

**Pack discovery** ([discover-packs.md](../../packs/grow_with_claudinite/discover-packs.md)) is an ordinary `run_daily` task — the
