...
import * as memberSide from '../../../../packs/grow_with_claudinite/tasks/adopt-requested-packs/protocol.mjs';
import { MEMBER_TASK } from '../../../../packs/sheepdog/tasks/fleet-add-missing-packs/worker.mjs';
import memberDecl from '../../../../packs/grow_with_claudinite/tasks/adopt-requested-packs/task.mjs';
...
test('the two protocol copies are byte-identical', () => {
  ...
  assert.equal(
    ...
    at('packs/grow_with_claudinite/tasks/adopt-requested-packs/protocol.mjs'),
  );
});
