...
test('pathAffectsMembers: member paths yes, orchestration/artifacts no', () => {
  for (const p of ['packs/tidy-repo/pack.mjs', 'engine/check_the_world.mjs', 'skills/x/SKILL.md', 'migrations/m.mjs', 'bootstrap.md', 'mount/sync-claudinite.sh', 'engine/hooks/session-start.sh']) {
