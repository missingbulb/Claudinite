...
- **Before opening the PR, `node growth/promote-scope.mjs` must exit clean** — it fails the run if a changed path escapes `packs/`/`skills/`, and its failure message says what to do.
