...
How to investigate a bug and pin down its root cause, independent of any one project. (For the broader, non-bug-specific engineering rules — naming, single source of truth, earning dependencies — see [engineeringPractices.md](engineeringPractices.md).)
