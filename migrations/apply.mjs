...
//   - settings      — declare a settings key the member does not carry yet
...
import { loadMigrations, applyFileAliases, applyMaterializations, applyRewrites, applySettings } from './registry.mjs';
...
async function main() {
  ...
  for (const m of migrations) {
    ...
    applied.push(...(await applySettings(m, { read, write })));
  }
