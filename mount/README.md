...
The session-start **steps** stay with the domain they belong to; `session-start.sh` reaches up one
level (`..`) to run them:

- `preferences/inject-preferences.sh` — injects the owner's interaction preferences.
