...
pack's [`stubs/`](../../../../../../packs/chrome-extension/stubs/) — the [orchestrator](../../../../../../packs/chrome-extension/stubs/workflows/chrome-extension-release.yml), the
five `workflow_call`-only **reusable workflows**, and the
[report-failure](../../../../../../packs/chrome-extension/stubs/actions/report-failure/action.yml),
[read-release-config](../../../../../../packs/chrome-extension/stubs/actions/read-release-config/action.yml) and
[bump-extension-patch](../../../../../../packs/chrome-extension/stubs/actions/bump-extension-patch/action.yml) composite actions — and
...
**Workflow** — **one** orchestrator per repo, [`chrome-extension-release.yml`](../../../../../../packs/chrome-extension/stubs/workflows/chrome-extension-release.yml), named exactly
...
1. Declare the pack in `.claudinite-settings.json`; baselining then **vendors the release set** — the
   [orchestrator](../../../../../../packs/chrome-extension/stubs/workflows/chrome-extension-release.yml) plus the reusable workflows under
   [`stubs/workflows/`](../../../../../../packs/chrome-extension/stubs/workflows/) and the composite actions under
   [`stubs/actions/`](../../../../../../packs/chrome-extension/stubs/actions/) — into this repo's own `.github/`. (Setting up before the next
...
2. **Add new item** → upload the release zip. If the extension pins its ID with a manifest
   ...
   [the chrome-extension pack RULES](../../../../../../packs/chrome-extension/RULES.md)), the **first** upload must NOT contain the
