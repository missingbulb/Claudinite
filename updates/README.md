...
both exist — lives in [`engine/served-by.mjs`](../engine/served-by.mjs) rather than
here, because baselining's worker runs from a member's vendored mount and must read
