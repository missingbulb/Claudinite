...
- [routines/auto-repo-tidy.md](routines/auto-repo-tidy.md) — retired into the [`tidy-repo`](packs/tidy-repo/README.md) pack (the PR/branch/issue sweep is now a pack a repo declares, run by the fleet routine).
