...
// seeds it and nothing maintains it after (packs/claudinite-tasks/converge-wiring.mjs).
...
test("this repo's README row is what the wiring converge would write", async () => {
  ...
  const { badgeRowEntries, renderBadgeRow } = await import('../../../packs/claudinite-tasks/converge-wiring.mjs');
