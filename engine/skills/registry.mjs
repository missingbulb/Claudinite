...
// This module is engine machinery (engine/skills/); the canon skills it scans
// live in the content tree at <canonRoot>/skills/, two levels up.
const skillsDir = join(dirname(dirname(dirname(fileURLToPath(import.meta.url)))), 'skills');
