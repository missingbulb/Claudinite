...
node --test engine-tests/*/*.test.mjs packs-tests/*/*.test.mjs skills-tests/*/*.test.mjs   # the test suite, exactly as CI runs it
```
...
[engine-tests/checks/helpers.mjs](../../engine-tests/checks/helpers.mjs); a violating fixture must find, a clean one must not.
...
`detect`, `rules`, and optional `prose`) — [engine/packs/registry.mjs](../packs/registry.mjs)
...
its test beside it, and [engine/skills/registry.mjs](../skills/registry.mjs) discovers it. **But a
