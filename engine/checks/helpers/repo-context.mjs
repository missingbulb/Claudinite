...
// below, and the wiring converge (packs/claudinite-tasks/converge-wiring.mjs) clears it.
...
//     anything (packs/claudinite-tasks/queue/scheduler-run.mjs), so no work item is instantiated,
...
// (mirrored from packs/claudinite-tasks/calendar.mjs WEEKDAYS — kept as a literal here so
