...
// This module is engine machinery (engine/packs/); the canon packs it scans
// live in the content tree at <canonRoot>/packs/, two levels up.
const packsDir = join(dirname(dirname(dirname(fileURLToPath(import.meta.url)))), 'packs');
