...
const MOUNT_IGNORE_TEXT = [
  '# GENERATED by Claudinite (engine/converge-wiring.mjs): session state the mount',
  "# holds and git must not. A repo's root .gitignore is the repo's own.",
  `/${SESSION_ROOT_NAME}/`,
].join('\n') + '\n';
