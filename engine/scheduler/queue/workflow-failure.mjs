...
export * from '../../../packs/claudinite-tasks/queue/workflow-failure.mjs';
import { runWorkflowFailure } from '../../../packs/claudinite-tasks/queue/workflow-failure.mjs';
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  runWorkflowFailure().catch((e) => { console.error(e); process.exit(1); });
}
