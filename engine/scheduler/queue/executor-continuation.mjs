...
export * from '../../../packs/claudinite-tasks/queue/executor-continuation.mjs';
import { runExecutorContinuation } from '../../../packs/claudinite-tasks/queue/executor-continuation.mjs';
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  runExecutorContinuation().catch((e) => { console.error(e); process.exit(1); });
}
