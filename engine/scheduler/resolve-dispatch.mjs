...
export * from '../../packs/claudinite-tasks/resolve-dispatch.mjs';
import { runResolveDispatch } from '../../packs/claudinite-tasks/resolve-dispatch.mjs';
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  runResolveDispatch().catch((e) => { console.error(e); process.exit(1); });
}
