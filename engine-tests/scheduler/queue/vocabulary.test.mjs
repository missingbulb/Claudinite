...
test('the executor triggers on both ready spellings, in the stub and in the canon\'s own copy', () => {
  for (const path of ['engine/scheduler/stubs/claudinite-executor.yml', '.github/workflows/claudinite-executor.yml']) {
...
import { pickOrder } from '../../../engine/scheduler/queue/executor.mjs';
import { planSchedulerRun } from '../../../engine/scheduler/queue/scheduler-run.mjs';
import { staleReadyItems, deadAgentItems, statelessItems } from '../../../engine/scheduler/queue/janitor-rules.mjs';
import { isReleasable } from '../../../engine/scheduler/queue/readiness.mjs';
