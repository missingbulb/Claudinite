...
export default patternRule({
  ...
  matchLines: [
    { match: BARE_ISSUER, whenFileMatches: ISSUER_WORD, unlessFileMatches: /\baud(ience)?\b/i, what: WHAT, fix: FIX },
    { match: BARE_ISSUER, whenFileMatches: [ISSUER_WORD, EMPTY_AUD], what: WHAT, fix: FIX },
  ],
});
