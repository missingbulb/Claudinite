// grow_with_claudinite task: adopt-requested-packs — adopt the packs this repo's
...
// This task is what that firing runs: code_work counts the repo's own open work-list
