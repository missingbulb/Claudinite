...
export default {
  ...
  // Pack-contributed maintenance task: the fleet plan picks this up only on repos that
  // declare chrome-extension-release. See maintenance/store-release.mjs.
  maintenance: [storeRelease],
};
