...
- **Reason:** copying a mechanic from a sibling repo is the tell that it belongs centrally.
...
- **Actor:** @missingbulb (owner).
- **Mechanism:** a RULES.md rule, triggered on "Building release, deploy, versioning or CI
  plumbing".
