...
| Choosing an automerge policy for a PR or a chain link | high | correctness | prose: 65 words |
| Predicting a change that could delete production data or degrade the experience past what a later PR undoes | critical | correctness | prose: 42 words |
| Handing over a change whose diff reached more folders or files than its request implied | medium | complexity | prose: 63 words |
