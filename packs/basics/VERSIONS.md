...
| 60824.1 | 2026-08-24 | `task-janitor` moves to the claudinite-tasks pack with the queue it sweeps (#1317); `ci-performance` reads its GitHub client and tracker off that pack's `shared-code/`. |
