...
|---|---|---|
| 60830.4 | 2026-08-30 | `do-later`'s `Automerge:` vocabulary carries the inline folder scope `under:<dir>`, so a deferral confined to one tree can authorize that tree and nothing else (#1473). |
