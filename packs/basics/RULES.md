...
An interactive comment from the owner carries one of three intents — classify it before acting, because the class decides where the change lands and what must exist before any fix:

1. **A correction** — you misunderstood something. Repair the shared understanding and adjust course; nothing new gets built.
