...
the `@.claudinite/shared/CLAUDE.md` import + self-check, open the
...
fresh canon to scratch, run its `engine/mount/apply-vendor.mjs` against the repo, commit the one
...
([engine/mount/DESIGN.md](../../../../engine/mount/DESIGN.md), phase 2); until then legacy members are maintained
