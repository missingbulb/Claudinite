...
description: Reconnaissance on a website you want data from: locate its real data surface before any parser exists. Use when adding a scraper source, or when one stops parsing.
metadata:
  body: workflow
  usage:
    expect: judgment
