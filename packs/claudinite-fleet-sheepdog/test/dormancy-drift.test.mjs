...
const DECLARATIONS = [
  ...
  { packs: [] }, { packs: ['basics'] }, { packs: [{ id: 'claudinite-tasks' }] }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
  { packs: [{ id: 'claudinite-tasks', config: { dormant: true } }] }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
  { packs: [{ id: 'claudinite-tasks', config: { dormant: false } }], dormant: true }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
  { packs: [{ id: 'claudinite-tasks', config: { dormant: { since: 1 } } }] }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
  { packs: [{ id: 'tasks', config: { dormant: true } }] },
  { packs: [{ id: 'claudinite-scheduler', config: { dormant: true } }] },
  { packConfig: { 'claudinite-tasks': { dormant: true } } }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
  { packConfig: { 'claudinite-tasks': {} }, packs: [{ id: 'claudinite-tasks', config: { dormant: true } }] }, // @real-entity dormancy is that pack's own setting; the drift guard reads its real key
