...
import * as enforcerSide from '../../../../packs/claudinite-fleet-sheepdog/tasks/fleet-add-missing-packs/protocol.mjs';
import * as memberSide from '../../../../packs/claudinite-lifecycle/tasks/adopt-requested-packs/protocol.mjs';
import { MEMBER_TASK } from '../../../../packs/claudinite-fleet-sheepdog/tasks/fleet-add-missing-packs/worker.mjs';
...
test('the task id the enforcer fires is the member task\'s directory id', () => {
  ...
  // member's scheduler run resolves the `wake` input against task ids, so a rename of the
