...
const summary = (over) => renderFitSummary({
  owner: 'acme', home: 'acme/claudinite-fleet-sheepdog', canonRepo: 'acme/Claudinite', packCount: 29,
...
test('renderFitSummary: names members with fits AND the ones that came back clean', () => {
  ...
  assert.match(s, /acme\/claudinite-fleet-sheepdog — the enforcer itself/);
});
