...
- **Mechanism:** a rule of the playbook template `templates/research-project.md`, triggered on "Keep
  decision rules free of the very prior you are trying to measure.".
