...
- **Mechanism:** a rule of the playbook template `templates/research-project.md`, triggered on "Take
  the suggestion seriously even when the project has declared a direction "exhausted."".
