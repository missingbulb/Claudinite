...
| 60823.1 | 2026-08-23 | Promote-to-canon (#99): a geo bounds query returns candidates, not answers — post-filter before treating a match as real; mirrored geohash test vectors now name the bisection-midpoint comparison-operator trap. |
