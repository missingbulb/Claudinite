...
description: The Firebase release standard: separate dev and prod projects, promoted deliberately. Use when planning a first release, splitting dev from prod, or editing firebase.json or .firebaserc.
metadata:
  body: workflow
  usage:
    expect: triggered
