...
- **Source:** GoogleCalendarEventCreator, the origin recipe.
- **Actor:** @missingbulb (owner).
- **Model:** Claude Fable 5, per the commit trailer.
- **Mechanism:** a `RULES.md` bullet in the per-stack rendering recipes.
- **Rejected:** rendering in a real browser - deterministic and dependency-light won, at a fidelity
  tradeoff the recipe states.
