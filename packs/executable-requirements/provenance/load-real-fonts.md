...
- **Source:** three worked implementations in the owner's fleet - GoogleCalendarEventCreator (the
  ...
  `saga` implementation).
- **Reason:** test environments default to a glyph-less stub that renders text as boxes, which makes
  a golden unreviewable. Recovered from the rule's own pre-#467 text.
