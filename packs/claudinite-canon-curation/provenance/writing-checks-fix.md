## 2026-08-15 · born · Claudinite growth: extract lessons (#887)
- **Actor:** @missingbulb (owner).
- **Mechanism:** a rule in the `claudinite` local pack's RULES.md. It stays prose: a judgment call
  with no static signature a scan could observe.
- **Landed:** #887 (Refs #863).
