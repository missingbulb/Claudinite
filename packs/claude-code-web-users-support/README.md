...
live. Today that is two: the pack each person brings with them, poured into the session by
...
reached by a shallow, blob-filtered, sparse `git clone` of that one directory.
