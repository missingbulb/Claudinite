...
|---|---|---|
| 60903.1 | 2026-09-03 | The two preference-recording rules move out of `RULES.md` into the `record-user-preference` skill, loaded when a person asks to record or change a preference; the prose keeps the setup-script rule (#1662). |
