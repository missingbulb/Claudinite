...
import { packQuestions, interviewState, renderPending } from '../../../../packs/claudinite-lifecycle/skills/adopt-claudinite/interview.mjs';

const CLI = fileURLToPath(new URL('../../../../packs/claudinite-lifecycle/skills/adopt-claudinite/interview.mjs', import.meta.url));
