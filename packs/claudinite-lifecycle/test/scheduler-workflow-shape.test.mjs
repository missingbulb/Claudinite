...
// The two-tick form is what the update writes now; a single daily hour is neither
...
// path an update cannot push, so each member held its hourly cron until its own apply-stage pull
