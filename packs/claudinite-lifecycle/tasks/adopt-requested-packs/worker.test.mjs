...
import { main, openWorkLists } from '../../../../packs/claudinite-lifecycle/tasks/adopt-requested-packs/worker.mjs';
import { LABEL } from '../../../../packs/claudinite-lifecycle/tasks/adopt-requested-packs/protocol.mjs';
