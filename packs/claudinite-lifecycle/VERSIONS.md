...
|---|---|---|
| 60822.2 | — | `update`'s `daily-2h` offset retires — it is the head of the morning chain, and the tasks that read the mount it converges declare `after:` rather than an earlier clock hour (§17.1). |
