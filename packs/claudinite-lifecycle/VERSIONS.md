...
|---|---|---|
| 60830.3 | 2026-08-30 | `update` and `adopt-requested-packs` declare the `pr`/`anything` pair — the vendored-mount lanes whose trust is the repo's delivery setting, not a diff class (#1459). |
