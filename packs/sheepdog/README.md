...
| sweep | task | asks |
|---|---|---|
| [check-fleet-coverage.mjs](check-fleet-coverage.mjs) | [fleet-census](tasks/fleet-census/task.md) (daily) | is this repo a **member**? → adoption issues |
| [check-fleet-freshness.mjs](check-fleet-freshness.mjs) | [fleet-freshness](tasks/fleet-freshness/task.md) (weekly) | is a member **keeping up**? → drift issues |
