...
- **Mechanism:** an action-scoped guard, blocking, declared in the pack's `declared-checks.json`,
  and dated `since` the day it landed so it judges no call made before it existed.
