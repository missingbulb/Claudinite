...
| 60903.2 | 2026-09-03 | `git-github-advanced` sharpens the repo-allowlist rule with the scoped-vs-scopeless asymmetry, and adds two promoted lessons: `search_code`'s index can undercount, and a multi-target sweep should subscribe to activity on every PR it leaves open, not a sample (#1451). |
