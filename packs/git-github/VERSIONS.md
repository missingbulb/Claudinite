...
|---|---|---|
| 60903.2 | 2026-09-03 | `git-github-advanced` notes that `issue_write`'s `labels` field also replaces the whole set, not just the body — lifted from missingbulb/ClaudiniteWebsite's local pack (#1409). |
