...
grow_with_claudinite pack's capture step and consumed by its per-repo
conversation-extract nightly. An orphan work-queue branch: never merged, files deleted by
the retention sweep once extracted and aged out. See the pack README
