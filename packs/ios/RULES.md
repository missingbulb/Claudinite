...
Portable practices for working on an iOS app: Xcode project mechanics, Info.plist usage-description strings, entitlements, code signing and provisioning, and simulator/device workflows.
