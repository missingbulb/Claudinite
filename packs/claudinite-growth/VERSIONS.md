...
| 60824.1 | 2026-08-24 | The task contract leaves with the queue (#1317): `usage-fold`, the four task-authoring checks, the `task-phase-discipline` declaration and the writing-tasks skill move to the claudinite-tasks pack; `growth-dedup` reads its GitHub client off that pack's `shared-code/`. |
