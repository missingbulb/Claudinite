...
|---|---|---|---|
| <img src="claudinite-lifecycle/badge.svg" width="18" height="18" alt=""> [claudinite-lifecycle](claudinite-lifecycle/README.md) | declared (seeded by `--init`, mandatory — pulled in via `basics` `requires`) | 10 | 6 (Claudinite's own surface, plus the scheduled-task contract) + 3 skills: adopt-claudinite, adopt-pack, diagnosing-mount-staleness |
...
| <img src="claudinite-fleet-sheepdog/badge.svg" width="18" height="18" alt=""> [claudinite-fleet-sheepdog](claudinite-fleet-sheepdog/README.md) | declared (opt-in; the fleet-enforcer repo only) | 1 | 5 (fleet-enforcer marker + config + the agentless `fleet-roster` daily task (coverage + freshness in one walk)) + 2 skills: running-fleet-levers, configuring-the-fleet |
| <img src="claude-code-web-users-support/badge.svg" width="18" height="18" alt=""> [claude-code-web-users-support](claude-code-web-users-support/README.md) | declared (seeded by `--init`) | 2 | 1 (the environment Setup script body) + 1 skill: record-user-preference (their personal interaction preferences) |
...
| <img src="chrome-extension/badge.svg" width="18" height="18" alt=""> [chrome-extension](chrome-extension/README.md) | manifest_version manifest | 10 | 11 (+ 5 skills: chrome-store-releases, extension-google-signin, content-script-modules, extension-host-permissions, probe-extension-worker-over-cdp) |
| <img src="node/badge.svg" width="18" height="18" alt=""> [node](node/README.md) | root package.json | 0 | 4 (+ 1 skill: node-test-discovery) |
| <img src="python/badge.svg" width="18" height="18" alt=""> [python](python/README.md) | pyproject.toml near root | 0 (2 in its skill) | 1 (+ 1 skill: python-optional-deps) |
| <img src="web-speech/badge.svg" width="18" height="18" alt=""> [web-speech](web-speech/README.md) | speech API in JS/TS source | 0 (2 in its skill) | 11 (+ 1 skill: web-speech-io) |
| <img src="leaflet/badge.svg" width="18" height="18" alt=""> [leaflet](leaflet/README.md) | Leaflet reference in HTML/JS source | 2 | 4 |
| <img src="headless-browser/badge.svg" width="18" height="18" alt=""> [headless-browser](headless-browser/README.md) | driver reference in JS/TS source | 0 | 7 (+ 3 skills: pixel-stable-goldens, hermetic-page, capture-a-screenshot) |
| <img src="aws-sam/badge.svg" width="18" height="18" alt=""> [aws-sam](aws-sam/README.md) | SAM template | 3 | 3 (+ 3 skills: sam-template, sam-deploy, sam-build-and-deps) |
...
| <img src="html/badge.svg" width="18" height="18" alt=""> [html](html/README.md) | declared | 0 | 3 (+ 1 skill: parsing-page-dates) |
| <img src="static-website/badge.svg" width="18" height="18" alt=""> [static-website](static-website/README.md) | declared (opt-in); marker: the `Release static site` orchestrator | 3 | 3 (+ RELEASE contract; 2 skills: static-site-releases, client-cache-manifest) |
| <img src="flutter/badge.svg" width="18" height="18" alt=""> [flutter](flutter/README.md) | pubspec.yaml | 0 | 7 (+ 3 skills: flutter-golden-tests, flutter-pubspec, flutter-port-architecture) |
...
| <img src="macos/badge.svg" width="18" height="18" alt=""> [macos](macos/README.md) | `Package.swift` near root | 3 | 2 (+ 7 skills: bundle / entitlements + TCC / speech recognition / signing + release / exit paths / sleep + wake / audio device lifecycle) |
...
| <img src="web-scraping/badge.svg" width="18" height="18" alt=""> [web-scraping](web-scraping/README.md) | declared (opt-in) | 0 | 12 (+ 3 skills: map-a-data-source, fetch-layer, time-at-the-boundary) |
| <img src="research-project/badge.svg" width="18" height="18" alt=""> [research-project](research-project/README.md) | declared (class) | 0 | 36 (10 sections; + 6 skills: source-intake, mine-session-for-preferences, ground-truth-extraction, add-an-external-corpus, write-an-iteration-note, define-and-calibrate-metrics) |
...
| <img src="spec-driven-product/badge.svg" width="18" height="18" alt=""> [spec-driven-product](spec-driven-product/README.md) | declared (class) | 0 | 21 (7 sections; + 2 skills: add-a-supported-target, mark-a-verification-gap) |
