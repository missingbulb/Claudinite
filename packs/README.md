...
| <img src="claudinite-tasks/badge.svg" width="18" height="18" alt=""> [claudinite-tasks](claudinite-tasks/README.md) | declared (seeded by `--init`, opt-out by removal — no scheduled work, updates via a human session) | 0 | 0 (the work-item queue, executor, task contract and delivery lane; `shared-code/` is its published import surface) |
