...
| <img src="cloudflare-pages/badge.svg" width="18" height="18" alt=""> [cloudflare-pages](cloudflare-pages/README.md) | wrangler static-assets config, or `pages deploy` in source | 0 | 5 |
