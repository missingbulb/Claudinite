...
|---|---|---|
| 60904.1 | 2026-09-04 | `promote-to-canon` (#1671): a scratchpad script can't reach the project's `node_modules`, check the Node version CI pins, and `btoa`/`atob` operate on Latin1 code units. |
