...
|---|---|---|
| 60823.2 | 2026-08-23 | Promote-to-canon (#99): a `node/test-discovery-resolves` check (new `worldRules/`) enforces the existing dot-directory-discovery prose, and Module resolution gains a scratch-script-outside-the-project-tree note. |
