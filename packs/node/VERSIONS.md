...
|---|---|---|
| 60902.2 | 2026-09-03 | `promote-to-canon` adds a rule: a local pass proves nothing about a pinned CI Node version — the agent sandbox's Node can be newer than what CI actually pins (#1372). |
