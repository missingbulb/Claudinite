...
| 60902.1 | 2026-09-02 | Real file or image I/O inside `testWidgets` needs `tester.runAsync` — the fake-async test zone never completes a real OS-level future, so the test hangs rather than failing (#1584). |
