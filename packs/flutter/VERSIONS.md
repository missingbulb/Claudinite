...
|---|---|---|
| 60902.2 | 2026-09-03 | `promote-to-canon` adds a WIP rule: real file/image I/O inside `testWidgets` must run inside `tester.runAsync`, or the fake-async test zone never completes it and the case hangs (#1345). |
