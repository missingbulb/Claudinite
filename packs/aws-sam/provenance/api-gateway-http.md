...
- **Rejected:** a check in this run - the promote flagged this one exception as having a static
  signature in a SAM template and left it on the conformance backlog rather than author it
  unattended.
