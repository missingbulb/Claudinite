...
| 60903.2 | 2026-09-03 | The extra-declaration rule moves out of `RULES.md` into the `python-optional-deps` skill, now forced for `pyproject.toml`, `setup.cfg` and `setup.py` (root or one directory down) (#1662). |
