...
| 60901.1 | 2026-09-01 | Recovers the rationale #467 cut from four rules into a new `references.md`; the `<p>` auto-close and its `innerHTML` qualification are verified against jsdom 30.0.1 (#1571). |
