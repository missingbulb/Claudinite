...
| 60903.1 | 2026-09-03 | The ambiguous slash-date rule moves out of `RULES.md` into the `parsing-page-dates` skill (its rationale entry follows it as `parsing-page-dates-2`); the prose keeps the always-on markup and live-page rules (#1662). |
