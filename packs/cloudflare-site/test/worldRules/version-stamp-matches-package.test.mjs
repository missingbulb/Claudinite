...
const base = {
  'wrangler.json': '{ "assets": { "directory": "./site" } }\n',
  'package.json': '{ "version": "1.0913.4" }\n',
};
...
ruleTester(versionStampMatchesPackage, {
  clean: {
    ...
    'a stamp outside the published tree': {
      files: { ...base, 'site/index.html': '<p>x</p>\n', 'docs/notes.html': '<p title="version 0.1">c</p>\n' },
    },
  },
  flagged: {
    'a stamp naming a version that was never served': {
      files: { ...base, 'site/index.html': '<p>x</p>\n<p class="copyright" title="version 1.0801.1">c</p>\n' },
      at: [{ file: 'site/index.html', line: 2, what: /names version 1\.0801\.1, but package\.json says 1\.0913\.4/ }],
    },
