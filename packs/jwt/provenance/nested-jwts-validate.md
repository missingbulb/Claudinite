...
- **Mechanism:** a guideline of the jwt-validation skill, triggered on "Nested JWTs: validate every
  layer."; that skill's file records why the judgment half rides a skill.
