...
- **Mechanism:** a guideline of the jwt-validation skill, triggered on "JWE is not authenticity when
  producer ≠ consumer."; that skill's file records why the judgment half rides a skill.
