...
- **Mechanism:** a guideline of the jwt-validation skill, triggered on "You pick the algorithm,
  never the token."; that skill's file records why the judgment half rides a skill.
