...
- **Mechanism:** a guideline of the jwt-validation skill, triggered on "Match key type to algorithm
  family."; that skill's file records why the judgment half rides a skill.
