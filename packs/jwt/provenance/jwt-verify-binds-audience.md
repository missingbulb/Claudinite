...
- **Source:** The JWT Handbook §8.1.6, substitution attacks, and §8.2.6.
- **Actor:** @missingbulb (owner).
- **Model:** Claude Opus 5, per the commit trailer.
- **Mechanism:** a coded world-scope rule module under the jwt-validation skill, advisory, with the
  same relevance gate, test-path exemption and file-level fallback the pack's other four rules take.
