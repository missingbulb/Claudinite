...
- **Mechanism:** a guideline of the jwt-validation skill, triggered on "One validation rule-set per
  token type."; that skill's file records why the judgment half rides a skill.
