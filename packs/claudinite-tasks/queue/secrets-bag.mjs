...
// One secret's value, or undefined — the plain environment, which is what every
// executor workflow stamps today, with the retired bag read first where a member's
// job still carries one (#1914).
