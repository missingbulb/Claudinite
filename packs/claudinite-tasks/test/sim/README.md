...
A discrete-event simulator of the [tasks-dispatch DESIGN](../../../../docs/tasks-dispatch/DESIGN.md), so
the scenario play-throughs in [SCENARIOS.md](../../../../docs/tasks-dispatch/SCENARIOS.md) run as tests
