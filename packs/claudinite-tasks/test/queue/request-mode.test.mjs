...
const TASK_PATH = 'packs/claudinite-tasks/queue/tasks/implement-request/task.md';

const REQUEST_TASK = {
  pack: 'engine', id: 'implement-request', taskDir: 'packs/claudinite-tasks/queue/tasks/implement-request',
