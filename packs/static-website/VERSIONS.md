...
| 60903.3 | 2026-09-03 | The three client-side freshness rules move out of `RULES.md` into the new `client-cache-manifest` skill and the version-bump and managed-stub-copy rules into `static-site-releases`; the prose keeps the always-on rules — the publish set, the subpath, missing data (#1662). |
