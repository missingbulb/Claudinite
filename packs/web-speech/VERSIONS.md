...
| 60903.2 | 2026-09-03 | The cloud-streaming / on-device probe, biasing, mic-permission preflight and content-script TTS relay rules move out of `RULES.md` into the `web-speech-io` skill; the prose keeps the always-on rules (#1662). |
