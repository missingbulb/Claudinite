...
|---|---|---|
| 60830.2 | 2026-08-30 | `wiki-growth` declares `may_automerge: ['doc-changes']` — the wiki is Markdown pages, and anything else in a round's diff parks it for review (#1459). |
