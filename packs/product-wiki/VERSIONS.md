...
|---|---|---|
| 60830.3 | 2026-08-30 | `wiki-growth` authorizes `under:product-wiki/` — the tree it already anchors its precondition on — instead of the repo-wide `doc-changes`, so the round may land its own wiki pages and a change anywhere else parks it for review (#1473). |
