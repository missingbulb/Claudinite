## 2026-08-30 · born · product-wiki: bundle the /explore-link skill (#1422)
- **Reason:** the pack grew its wikis on one lane only, the weekly pass that picks its own targets
  from each page's open questions. This is the other lane, where the owner hands over the source and
  the judgment is which page it feeds and what it turns out not to say.
