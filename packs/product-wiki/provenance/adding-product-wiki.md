...
- **Mechanism:** a RULES.md rule, triggered on "sample-data and new wikis.".
...
- **Mechanism:** a guideline of the writing-wiki-pages skill, triggered on "Adding to
  product-wiki/sample-data/, or a new wiki folder.", in place of its RULES.md bullet.
