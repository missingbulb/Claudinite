...
- **Mechanism:** a RULES.md rule, triggered on "Compile once, refine in place.".
...
- **Mechanism:** a guideline of the writing-wiki-pages skill, triggered on "Starting a pass on a
  page.", in place of its RULES.md bullet.
