...
- **Mechanism:** a RULES.md rule, triggered on "The header is a current view, not a log.".
...
- **Mechanism:** a guideline of the writing-wiki-pages skill, triggered on "Touching the header
  after a pass.", in place of its RULES.md bullet.
