...
- **Mechanism:** a RULES.md rule, triggered on "Cited, never silently rewritten.".
...
- **Mechanism:** a guideline of the writing-wiki-pages skill, triggered on "Writing a claim.", in
  place of its RULES.md bullet.
