...
- **Source:** the second exemplar run, against missingbulb/GoogleCalendarEventCreator, whose
  supported-targets treatment is the whole section this rule opens.
- **Reason:** a supported-targets matrix is spec, not folklore.
- **Actor:** @missingbulb (owner).
- **Model:** Claude Fable 5, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "When part of the product's value is breadth over
  external targets".
