...
- **Source:** the second exemplar run, against missingbulb/GoogleCalendarEventCreator, which the
  pull request records as sharpening the gap-honesty section.
- **Actor:** @missingbulb (owner).
- **Model:** Claude Fable 5, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "Deliberate gaps are marked at the leaf and
  committed, never remembered.".
