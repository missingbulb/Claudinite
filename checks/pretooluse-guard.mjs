...
// engine/hooks/pretooluse-guard.mjs. A pre-flip member's frozen wiring still invokes
...
const real = fileURLToPath(new URL('../engine/hooks/pretooluse-guard.mjs', import.meta.url));
