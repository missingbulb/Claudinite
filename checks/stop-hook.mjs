...
// engine/checks/check_the_work.mjs. A pre-flip member's frozen wiring still invokes
...
const real = fileURLToPath(new URL('../engine/checks/check_the_work.mjs', import.meta.url));
