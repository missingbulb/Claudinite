...
Portable rules for *how to structure an unattended (automation-invoked) agent* —
the judgment-boundary and write-surface guarantees that keep a workflow-driven
agent bounded and reliable, independent of any one project.
