...
| Baseline-migration mechanism | [`migrations/`](migrations/README.md) | the read-side resolver and write-side rename for a relocation; records are kept forever, and vendoring's 7-day recency window decides what ships to consumers |
