...
([packs/registry.mjs](packs/registry.mjs)); the mechanism is fixed, the content is open. New
...
| Skill mounting | `skills/mount-skills.mjs` | per-session symlink of the active packs' bundled-skill union (`<pack>/skills/<name>/`) |
