## 2026-08-06 · born · Move the shipped-automation credential rule out of basics into the canon's own pack (#670)
...
- **Actor:** @missingbulb (owner).
- **Model:** Claude Opus 5, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "Needing a member to flip a platform setting". it was
