...
- **Reason:** `task-janitor`'s preconditions were its cadence and nothing else, which cannot
  decline: 7 items a week, each closed within the hour, to report a healthy queue. The canon's own
