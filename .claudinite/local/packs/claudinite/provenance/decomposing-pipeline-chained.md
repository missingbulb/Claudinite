...
- **Reason:** stages chained by a passed-forward parameter cannot self-heal after an interrupted
  run; each precondition re-deriving world state can (#1073).
- **Actor:** @missingbulb (owner).
- **Model:** Claude, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "Decomposing a pipeline into chained tasks".
