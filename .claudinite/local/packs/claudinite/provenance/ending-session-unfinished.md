...
## 2026-09-20 · reworded · Claudinite growth: dedup local packs (#2160)
- **Reason:** the dedup found the first half verbatim in `packs/basics/RULES.md`; what the canon
  does not carry is the ban on composing a hand-off prompt and this owner's opener, and that is what
  stayed.
- **Actor:** @missingbulb (owner).
- **Landed:** #2160 (Refs #2148).
