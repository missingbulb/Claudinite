...
- **Reason:** a silently-dead safety knob defaults to the operation's most dangerous mode (#974);
  owner-authored.
- **Actor:** @missingbulb (owner).
- **Model:** Claude, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "Retiring or migrating a dispatch/config parameter
  channel".
- **Landed:** #979.
