...
- **Reason:** a uniform signal across the whole fleet right after a shared mechanism changed needs a
  timing check before it reads as frozen (#801, #939).
- **Actor:** @missingbulb (owner).
- **Model:** Claude, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "Reading a uniform signal across every fleet member".
- **Landed:** #979.
