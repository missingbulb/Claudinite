...
- **Reason:** the head ref is deleted on squash-merge here, so the next push was rejected on a stale
  tracking ref (#922).
- **Actor:** @missingbulb (owner).
- **Model:** Claude, per the commit trailer.
- **Mechanism:** a RULES.md rule, triggered on "After a PR lands by squash-merge".
- **Landed:** #944 (Refs #943).
